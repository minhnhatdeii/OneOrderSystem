package com.example.oneorder_sm.ui.theme

import androidx.compose.ui.graphics.Color

// Primary Brand Color: #228BE2
val Primary = Color(0xFF228BE2)
val PrimaryLight = Color(0xFF5BABFF)
val PrimaryDark = Color(0xFF1565C0)
val PrimaryContainer = Color(0xFFD6EAFF)
...
// Dark Theme Colors
val PrimaryDarkTheme = Color(0xFF9ECAFF)
val OnPrimaryDarkTheme = Color(0xFF003258)
...
val SidebarItemSelected = Color(0xFF228BE2)
val SidebarItemHover = Color(0xFF2E3D50)
val SidebarText = Color(0xFFE2E2E6)
val SidebarTextMuted = Color(0xFF9EA3AB)

// Brand Text Colors for "OneOrder" styling
val OneTextColor = Color.Black
val OrderTextColor = Color(0xFF228BE2)  // Matches Primary brand color